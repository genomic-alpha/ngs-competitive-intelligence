...
const PRODUCTS = [
  ...
  { id: 'beckman-ampure-ext', vendor: 'beckman', name: 'Beckman Ampure', category: 'Extraction', tier: 'B', share: 8, pricing: 3, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:8,we:6,hg:5,od:6}, growth: "stable", indications: ["solid_tumor","liquid_biopsy","hereditary_cancer","heme_malig","rare_disease"], indicationShare: {}, confidence: {share:{level:"estimated",source:"DeciBio/Grand View + validation",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources + validation",date:"2026-Q1"},regulatory:{level:"verified",source:"Validated 2026-Q1",date:"2026-Q1"}} },
  { id: 'zymo-ffpe-ext', vendor: 'zymo', name: 'Zymo Quick-DNA/RNA FFPE Kit', category: 'Extraction', tier: 'B', share: 4, pricing: 7, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe"], nucleicAcids: ["dna","rna"], regionalShare: {na:6,we:4,hg:3,od:3}, growth: "growing", indications: ["solid_tumor","heme_malig"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'zymo-cfdna-ext', vendor: 'zymo', name: 'Zymo Quick-cfDNA Serum & Plasma Kit', category: 'Extraction', tier: 'B', share: 3, pricing: 9, regulatory: 'RUO', region: 'global', sampleTypes: ["blood","cfdna"], nucleicAcids: ["dna"], regionalShare: {na:5,we:3,hg:2,od:2}, growth: "growing", indications: ["liquid_biopsy"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'mn-nucleomag-ext', vendor: 'macherey_nagel', name: 'Macherey-Nagel NucleoMag DNA/RNA FFPE', category: 'Extraction', tier: 'B', share: 5, pricing: 6, regulatory: 'CE-IVD', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:3,we:12,hg:4,od:6}, growth: "stable", indications: ["solid_tumor","hereditary_cancer","rare_disease"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"estimated",source:"EU distributor data",date:"2026-Q1"}} },
  { id: 'omega-magbind-ext', vendor: 'omega', name: 'Omega Mag-Bind TotalPure NGS', category: 'Extraction', tier: 'C', share: 3, pricing: 2, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:4,we:2,hg:5,od:3}, growth: "growing", indications: ["solid_tumor","hereditary_cancer","rare_disease"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'omega-cfdna-ext', vendor: 'omega', name: 'Omega Mag-Bind cfDNA Kit', category: 'Extraction', tier: 'C', share: 2, pricing: 8, regulatory: 'RUO', region: 'global', sampleTypes: ["blood","cfdna"], nucleicAcids: ["dna"], regionalShare: {na:3,we:1,hg:3,od:2}, growth: "growing", indications: ["liquid_biopsy"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'qiagen-qiasymphony-ext', vendor: 'qiagen', name: 'QIAsymphony DSP DNA/RNA', category: 'Extraction', tier: 'A', share: 12, pricing: 10, regulatory: 'CE-IVD', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:14,we:18,hg:10,od:14}, growth: "stable", indications: ["solid_tumor","liquid_biopsy","hereditary_cancer","heme_malig","rare_disease"], indicationShare: {}, confidence: {share:{level:"estimated",source:"DeciBio/Grand View + validation",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"EU EUDAMED",date:"2026-Q1"}} },
  { id: 'promega-maxwell-ffpe', vendor: 'promega', name: 'Promega Maxwell RSC FFPE DNA/RNA', category: 'Extraction', tier: 'B', share: 6, pricing: 8, regulatory: 'CE-IVD', region: 'global', sampleTypes: ["ffpe"], nucleicAcids: ["dna","rna"], regionalShare: {na:8,we:5,hg:4,od:5}, growth: "growing", indications: ["solid_tumor","heme_malig"], indicationShare: {}, confidence: {share:{level:"estimated",source:"DeciBio/Grand View + validation",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"EU EUDAMED",date:"2026-Q1"}} },
  { id: 'promega-maxwell-blood', vendor: 'promega', name: 'Promega Maxwell RSC Blood DNA', category: 'Extraction', tier: 'B', share: 4, pricing: 6, regulatory: 'CE-IVD', region: 'global', sampleTypes: ["blood"], nucleicAcids: ["dna"], regionalShare: {na:6,we:3,hg:3,od:3}, growth: "growing", indications: ["hereditary_cancer","liquid_biopsy"], indicationShare: {}, confidence: {share:{level:"estimated",source:"DeciBio/Grand View + validation",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"EU EUDAMED",date:"2026-Q1"}} },
  ...
  { id: 'neb-nebnext-direct', vendor: 'neb', name: 'NEBNext Direct Targeted Panels', category: 'Library Prep', tier: 'C', share: 1.0, pricing: 75, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:1,we:1,hg:0,od:0}, growth: "emerging", indications: ["solid_tumor","hereditary_cancer"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources + validation",date:"2026-Q1"},regulatory:{level:"verified",source:"Validated 2026-Q1",date:"2026-Q1"}} },
  { id: 'biorad-ddseq', vendor: 'biorad', name: 'Bio-Rad ddSEQ Library Prep', category: 'Library Prep', tier: 'C', share: 1.0, pricing: 65, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:1,we:1,hg:0,od:0}, growth: "emerging", indications: ["solid_tumor","hereditary_cancer"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources + validation",date:"2026-Q1"},regulatory:{level:"verified",source:"Validated 2026-Q1",date:"2026-Q1"}} },
  { id: 'seqonce-rapidseq', vendor: 'seqonce', name: 'SeqOnce RapidSeq Library Prep', category: 'Library Prep', tier: 'C', share: 1.0, pricing: 18, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood"], nucleicAcids: ["dna","rna"], regionalShare: {na:1,we:1,hg:0,od:0}, growth: "emerging", indications: ["solid_tumor"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources + validation",date:"2026-Q1"},regulatory:{level:"verified",source:"Validated 2026-Q1",date:"2026-Q1"}} },
  ...
  { id: 'nvidia-parabricks', vendor: 'nvidia', name: 'NVIDIA Parabricks', category: 'Analysis', tier: 'B', share: 5, pricing: 3, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:6,we:4,hg:2,od:3}, growth: "growing", indications: ["solid_tumor","hereditary_cancer","rare_disease","heme_malig"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"NVIDIA licensing",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'broad-gatk', vendor: 'broad', name: 'GATK (Genome Analysis Toolkit)', category: 'Analysis', tier: 'A', share: 25, pricing: 0, regulatory: 'Open Source', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:16,we:14,hg:10,od:12}, growth: "stable", indications: ["solid_tumor","hereditary_cancer","rare_disease","heme_malig"], indicationShare: {}, confidence: {share:{level:"estimated",source:"Academic surveys + DeciBio",date:"2026-Q1"},pricing:{level:"verified",source:"Open source",date:"2026-Q1"},regulatory:{level:"verified",source:"Broad Institute",date:"2026-Q1"}} },
  { id: 'sentieon-dnascope', vendor: 'sentieon', name: 'Sentieon DNAscope/TNscope', category: 'Analysis', tier: 'B', share: 4, pricing: 5, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:5,we:4,hg:2,od:3}, growth: "growing", indications: ["solid_tumor","hereditary_cancer","rare_disease","heme_malig"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Commercial licensing",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'qiagen-clc', vendor: 'qiagen', name: 'QIAGEN CLC Genomics Workbench', category: 'Analysis', tier: 'B', share: 8, pricing: 20, regulatory: 'CE-IVD', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:5,we:6,hg:4,od:5}, growth: "stable", indications: ["solid_tumor","hereditary_cancer","rare_disease","heme_malig","infectious_disease"], indicationShare: {}, confidence: {share:{level:"estimated",source:"DeciBio/Grand View + validation",date:"2026-Q1"},pricing:{level:"estimated",source:"Public sources",date:"2026-Q1"},regulatory:{level:"verified",source:"EU EUDAMED",date:"2026-Q1"}} },
  { id: 'pacbio-smrt-link', vendor: 'pacbio', name: 'PacBio SMRT Link', category: 'Analysis', tier: 'C', share: 2, pricing: 0, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood","tissue"], nucleicAcids: ["dna","rna"], regionalShare: {na:3,we:2,hg:1,od:1}, growth: "growing", indications: ["rare_disease","hereditary_cancer"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"verified",source:"Bundled with instrument",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'oxford-epi2me', vendor: 'oxford', name: 'Oxford Nanopore EPI2ME', category: 'Analysis', tier: 'C', share: 2, pricing: 0, regulatory: 'RUO', region: 'global', sampleTypes: ["ffpe","blood","tissue"], nucleicAcids: ["dna","rna"], regionalShare: {na:2,we:2,hg:1,od:1}, growth: "growing", indications: ["rare_disease","infectious_disease","hereditary_cancer"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"verified",source:"Bundled with platform",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },
  { id: 'dnaxnexus-platform', vendor: 'dnaxnexus', name: 'DNAnexus Apollo Platform', category: 'Analysis', tier: 'B', share: 4, pricing: 15, regulatory: 'ISO 13485', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:5,we:3,hg:2,od:2}, growth: "growing", indications: ["solid_tumor","hereditary_cancer","rare_disease","pharmacogenomics"], indicationShare: {}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Enterprise licensing",date:"2026-Q1"},regulatory:{level:"verified",source:"Vendor website",date:"2026-Q1"}} },

  // REPORTING
  { id: 'qci-interpret', vendor: 'qiagen', name: 'QCI-Interpret', category: 'Reporting', tier: 'A', share: 30, pricing: 50, regulatory: 'CE-IVDR', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:15,we:14,hg:9,od:12}, growth: "stable", indications: ["solid_tumor","hereditary_cancer","heme_malig"], indicationShare: {solid_tumor:{global:24,na:28,we:22,hg:14,od:18},hereditary_cancer:{global:18,na:20,we:18,hg:10,od:15}}, confidence: {share:{level:"estimated",source:"DeciBio 2024 + validation",date:"2026-Q1"},pricing:{level:"estimated",source:"Channel intelligence",date:"2026-Q1"},regulatory:{level:"verified",source:"EU EUDAMED + validation",date:"2026-Q1"}} },
  ...
  { id: 'emedgene-interpret', vendor: 'emedgene', name: 'Emedgene (Illumina) AI Interpretation', category: 'Reporting', tier: 'B', share: 8, pricing: 40, regulatory: 'CE-IVD', region: 'global', sampleTypes: ["ffpe","blood","cfdna"], nucleicAcids: ["dna","rna"], regionalShare: {na:5,we:4,hg:2,od:3}, growth: "growing", indications: ["rare_disease","hereditary_cancer"], indicationShare: {rare_disease:{global:12,na:14,we:10,hg:6,od:8},hereditary_cancer:{global:6,na:8,we:5,hg:3,od:4}}, confidence: {share:{level:"approximate",source:"Channel intelligence",date:"2026-Q1"},pricing:{level:"estimated",source:"Enterprise licensing",date:"2026-Q1"},regulatory:{level:"estimated",source:"EU regulatory tracking",date:"2026-Q1"}} },
];
